 ...
 */
class Mage_Payco_Block_Gateway_Success extends Mage_Core_Block_Template
{
    private $_order;
     ...
     * @return string
     */
    public function getPolMessage()
    {
        return Mage::getSingleton('checkout/session')->getPolMessage();
    }
     ...
     * @return string
     */
    public function getPolPayMethod()
    {
        return Mage::getSingleton('checkout/session')->getPolPayMethod();
    }
    
    public function getPolValor()
    {
        return Mage::getSingleton('checkout/session')->getPolValor();
    }
    
    public function getPolRef()
    {
        return Mage::getSingleton('checkout/session')->getPolRef();
    }
