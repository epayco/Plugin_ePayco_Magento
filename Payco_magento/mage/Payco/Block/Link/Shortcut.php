 ...
 */
class Mage_Payco_Block_Link_Shortcut extends Mage_Core_Block_Template
{
    public function getCheckoutUrl()
    {
        #return $this->getUrl('PagosOnLine/cba', array('_secure'=>true));
        return $this->getUrl('Payco/cba/shortcut');
    }

    public function getImageUrl()
    {
        return Mage::getStoreConfig('payment/Payco_cba/button_url');
    
    }

    public function _toHtml()
    {
        if (Mage::getStoreConfigFlag('payment/Payco_cba/active')
    ...
    {
        if (Mage::getStoreConfigFlag('payment/Payco_cba/sandbox_flag')) {
    ...
    {
        return Mage::getStoreConfigFlag('payment/Payco_cba/use_oneclick');
    }
