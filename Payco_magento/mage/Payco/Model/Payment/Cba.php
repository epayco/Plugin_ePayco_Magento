...
class Mage_Payco_Model_Payment_Cba extends Mage_Payment_Model_Method_Abstract
{
    /**
    ...
    protected $_code  = 'Payco_cba';
    protected $_formBlockType = 'Payco/cba_form';
    protected $_api;
...
//    const ACTION_AUTHORIZE_CAPTURE = 1;
    ...
    {
        return Mage::getStoreConfig('payment/Payco_cba/active');
    }
...
public function returnPol()
    ...
    {
        if (!$this->_api) {
            $this->_api = Mage::getSingleton('Payco/api_cba');
    ...
    /**
     * Get Payco session namespace
     *
     * @return Mage_Payco_Model_Session
     */
    public function getSession()
    {
        return Mage::getSingleton('Payco/session');
    }
    ...
    {
        return Mage::getUrl('Payco/cba/redirect');
    }
     ...
     * @return  Mage_Payco_Model_Payment_Cba
     */
    ...
    public function handleCallback($_request)
    {
        ...
        if (!empty($_request['order-calculations-request'])) {
            ...
            if ($xml) {
                ...
                $secretKeyID = Mage::getStoreConfig('payment/Payco_cba/secretkey_id');
                ...
                $response .= '&aws-access-key-id='.urlencode(Mage::getStoreConfig('payment/Payco_cba/accesskey_id'));
...
//        $this->getQuote()->getShippingAddress()->setShippingMethod($shippingMethod);
    ...
    public function callbackXmlError(Exception $e)
    {
        ...
        $response = 'order-calculations-response='.urlencode($_xml->asXML())
                ...
                .'&aws-access-key-id='.urlencode(Mage::getStoreConfig('payment/Payco_cba/accesskey_id'));
        return $response;
    }
    ...
    public function getCheckoutXmlFormFields()
    {
        ...
        $xmlCart = array('order-input' =>
            ...
            ."aws-access-key-id:".Mage::getStoreConfig('payment/Payco_cba/accesskey_id')
            );
        if ($this->getDebug()) {
            $debug = Mage::getModel('Payco/api_debug')
