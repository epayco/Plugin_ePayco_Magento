 ...
 */
class Mage_PagosOnLine_Model_Api_Cba_Document extends Varien_Object
{
     ...
     * @return Mage_PagosOnLine_Model_Api_Cba_Document
     */
    ...
    {
        return Mage::helper('pagosonline')->formatAmount($amount);
    }
