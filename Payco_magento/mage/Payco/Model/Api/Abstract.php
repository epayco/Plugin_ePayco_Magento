...
/**
 * Payco Base API Model
 *
 * @category   Mage
 * @package    Mage_Payco
 * @author     Magento Core Team <core@magentocommerce.com>
 */
abstract class Mage_Payco_Model_Api_Abstract extends Varien_Object
{
    /*
     * payment actions
     */
    ...
    protected function _getSignatureForArray($array, $secretKey)
    {
        ...
        $tmpString = $secretKey . '~' . $array['usuarioId'] . '~' . $array['refVenta']. '~' . $array['valor'] . '~' . $array['moneda'];
        return md5($tmpString);
