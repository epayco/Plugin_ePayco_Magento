...
class Mage_Payco_CbaController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    {
        return Mage::getSingleton('Payco/payment_cba');
    }
    ...
    public function shortcutAction()
    {
        ...
        if ($quoteId = $this->getCheckout()->getQuoteId()) {
            ...
            if ($quote->hasItems()) {
                ...
                $this->getResponse()->setBody($this->getLayout()->createBlock('Payco/cba_redirect')->toHtml());
